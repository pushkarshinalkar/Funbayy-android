...
public class RecomMovies_List_Adapter extends RecyclerView.Adapter<RecomMovies_List_Adapter.ViewHolder> {

    private List<Movies_ModelClass> userList;

//    String epposition

    public RecomMovies_List_Adapter(List<Movies_ModelClass> userList) {
