...
public class Movies_List_Adapter extends RecyclerView.Adapter<Movies_List_Adapter.ViewHolder> {

    private List<Movies_ModelClass> userList;

//    String epposition

    public Movies_List_Adapter(List<Movies_ModelClass> userList) {
...
//        shimmerDrawable.setShimmer(shimmer);
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_design_movie, parent, false);
