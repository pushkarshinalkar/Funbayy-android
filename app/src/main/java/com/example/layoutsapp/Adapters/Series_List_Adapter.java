...
public class Series_List_Adapter extends RecyclerView.Adapter<Series_List_Adapter.ViewHolder> {

    private List<Series_ModelClass> userList;

//    String epposition

    public Series_List_Adapter(List<Series_ModelClass>userList) {
    ...
    @Override
    public void onViewAttachedToWindow(@NonNull @NotNull Series_List_Adapter.ViewHolder holder) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view= LayoutInflater.from(parent.getContext()).inflate(R.layout.item_design_series,parent,false);
