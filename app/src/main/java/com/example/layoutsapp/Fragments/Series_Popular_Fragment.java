...
public class Series_Popular_Fragment extends Fragment {
    ...
    SwipeRefreshLayout swipeRefreshLayoutSerPop;
    Context context;
    ...
    public View onCreateView(@NonNull @NotNull LayoutInflater inflater, @Nullable @org.jetbrains.annotations.Nullable ViewGroup container, @Nullable @org.jetbrains.annotations.Nullable Bundle savedInstanceState) {
        ...
        return inflater.inflate(R.layout.series_frag_layout, container, false);
    ...
    public void onViewCreated(@NonNull @NotNull View view, @Nullable @org.jetbrains.annotations.Nullable Bundle savedInstanceState) {
        ...
        swipeRefreshLayoutSerPop = view.findViewById(R.id.swipeRefreshSeriesPop);
        progressBar = view.findViewById(R.id.progressBarPopularSerID);
        loadingLotteani = view.findViewById(R.id.animationViewLoadingSerPop);
        bottomlottieTV = view.findViewById(R.id.bottomlottieTextviewSerPop);
        ...
        if (getActivity() != null && sharedPref.getPopularSerLink().equals("")) {
//            Toast.makeText(context, "not null", Toast.LENGTH_SHORT).show();
            ...
            JsonObjectRequest jsonObjectRequest0 = new JsonObjectRequest(Request.Method.GET, urlMain, null, new Response.Listener<JSONObject>() {
                ...
                public void onResponse(JSONObject response) {
                    ...
                    try {
                        String link = response.getString("Series_Popular_Link");
                        sharedPref.setPopularSerLink(link);
...
//            Toast.makeText(context, "null", Toast.LENGTH_SHORT).show();
            requestQueue = Volley.newRequestQueue(getActivity());
            String link = sharedPref.getPopularSerLink();
...
//                    Toast.makeText(getContext(), "Reached Top", Toast.LENGTH_SHORT).show();
            ...
            swipeRefreshLayoutSerPop.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
                @Override
                public void onRefresh() {
                    swipeRefreshLayoutSerPop.setRefreshing(false);
                    userList.clear();
...
//                    deleteCache(getContext());
            ...
            swipeRefreshLayoutSerPop.setColorSchemeColors(Color.BLACK);
...
//            loadingPB.setVisibility(View.GONE);
        ...
        String url1 = sharedPref.getPopularSerLink() + location + "&page=" + page;
        RequestQueue requestQueue;
        if (getActivity() != null) {
