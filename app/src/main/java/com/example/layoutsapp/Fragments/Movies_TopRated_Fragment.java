...
public class Movies_TopRated_Fragment extends Fragment {
    ...
    public void onViewCreated(@NonNull @NotNull View view, @Nullable @org.jetbrains.annotations.Nullable Bundle savedInstanceState) {
        ...
        swipeRefreshLayout = view.findViewById(R.id.swipeRefreshMovTopRated);
        progressBar = view.findViewById(R.id.progressBarTopRatedMovies);
        progressBar.setVisibility(View.GONE);
//        shimmerFrameLayoutmovie.startShimmer();
        mrecyclerView = view.findViewById(R.id.RecyclerViewTopRatedMovies);
        layoutManager = new GridLayoutManager(getContext(),3);
        mrecyclerView.setLayoutManager(layoutManager);
        adapter = new Movies_List_Adapter(userList);
        mrecyclerView.setAdapter(adapter);
        loadingLotteani = view.findViewById(R.id.animationViewLoadingMovTop);
        bottomLottieTV = view.findViewById(R.id.bottomlottieTextviewTopMov);
        ...
        if (getActivity() != null && sharedPref.getTopRatedMovLink().equals("")) {
//            Toast.makeText(context, "not null", Toast.LENGTH_SHORT).show();
            ...
            JsonObjectRequest jsonObjectRequest0 = new JsonObjectRequest(Request.Method.GET, urlMain, null, new Response.Listener<JSONObject>() {
                ...
                public void onResponse(JSONObject response) {
                    ...
                    try {
                        String link = response.getString("Movies_topRated_Link");
                        sharedPref.setTopRatedMovLink(link);
...
//            Toast.makeText(context, "null", Toast.LENGTH_SHORT).show();
            requestQueue = Volley.newRequestQueue(getActivity());
            String link = sharedPref.getTopRatedMovLink();
...
//            loadingPB.setVisibility(View.GONE);
        ...
        String url1 = sharedPref.getTopRatedMovLink() + location + "&page=" + page;
