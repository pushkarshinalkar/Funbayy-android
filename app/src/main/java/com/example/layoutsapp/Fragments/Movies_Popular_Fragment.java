...
public class Movies_Popular_Fragment extends Fragment {
    ...
    Context context;
    ConstraintLayout constraintLayoutShimCont;
    ...
    public View onCreateView(@NonNull @NotNull LayoutInflater inflater, @Nullable @org.jetbrains.annotations.Nullable ViewGroup container, @Nullable @org.jetbrains.annotations.Nullable Bundle savedInstanceState) {
        ...
        return inflater.inflate(R.layout.movie_frag_layout, container, false);
    ...
    public void onViewCreated(@NonNull @NotNull View view, @Nullable @org.jetbrains.annotations.Nullable Bundle savedInstanceState) {
        ...
        bottomLottieTv = view.findViewById(R.id.bottomlottieTextviewPopMov);
        loadingLotteani = view.findViewById(R.id.animationViewLoadingMovPop);
//        loadingLotteani.setSpeed(2f);
        swipeRefreshLayout = view.findViewById(R.id.swipeRefreshMovPop);
        constraintLayoutShimCont = view.findViewById(R.id.constmov);
//        containerShimmer = view.findViewById(R.id.shimmerframePopularMovieID);
        progressBar = view.findViewById(R.id.progressBarPopularMovID);
        mrecyclerView = view.findViewById(R.id.RecyclerViewMovie);
...
//        containerShimmer.startShimmer();
        ...
        if (getActivity() != null && sharedPref.getPopularMovLink().equals("")) {

//            Toast.makeText(context, "shared pref empty", Toast.LENGTH_SHORT).show();
            ...
            JsonObjectRequest jsonObjectRequest0 = new JsonObjectRequest(Request.Method.GET, urlMain, null, new Response.Listener<JSONObject>() {
                ...
                public void onResponse(JSONObject response) {
                    ...
                    try {
                        String link = response.getString("Movies_Popular_Link");
                        sharedPref.setPopularMovLink(link);
...
//                                    Toast.makeText(context, page, Toast.LENGTH_SHORT).show();
                            ...
                            public void onErrorResponse(VolleyError error) {
                                ...
                                Toasty.warning(context, "No Internet Connection pages").show();
...
//            Toast.makeText(context, "shared pref full", Toast.LENGTH_SHORT).show();
            requestQueue = Volley.newRequestQueue(getActivity());
            String link = sharedPref.getPopularMovLink();
...
//            loadingPB.setVisibility(View.GONE);
        ...
        String url1 = sharedPref.getPopularMovLink() + location + "&page=" + page;
