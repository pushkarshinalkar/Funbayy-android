...
public class Series_TopRated_Fragment extends Fragment {
    ...
    SwipeRefreshLayout swipeRefreshLayoutSerTopRated;
    Context context;
...
//    ShimmerFrameLayout containerShimmer;
    ...
    public View onCreateView(@NonNull @NotNull LayoutInflater inflater, @Nullable @org.jetbrains.annotations.Nullable ViewGroup container, @Nullable @org.jetbrains.annotations.Nullable Bundle savedInstanceState) {
        ...
        return inflater.inflate(R.layout.fragment_series_top_rated, container, false);
    ...
    public void onViewCreated(@NonNull @NotNull View view, @Nullable @org.jetbrains.annotations.Nullable Bundle savedInstanceState) {
        ...
        swipeRefreshLayoutSerTopRated = view.findViewById(R.id.swipeRefreshSeriesTopRated);
        progressBar = view.findViewById(R.id.progressBarTopratedSerID);
        loadingLotteani = view.findViewById(R.id.animationViewLoadingSerTop);
        bottomLottieTV = view.findViewById(R.id.bottomlottieTextviewSerTop);
        userList = new ArrayList<>();

        mrecyclerView = view.findViewById(R.id.RecyclerViewTopRatedSeries);
        ...
        if (getActivity() != null && sharedPref.getTopRatedSerLink().equals("")) {
//            Toast.makeText(context, "not null", Toast.LENGTH_SHORT).show();
            ...
            JsonObjectRequest jsonObjectRequest0 = new JsonObjectRequest(Request.Method.GET, urlMain, null, new Response.Listener<JSONObject>() {
                ...
                public void onResponse(JSONObject response) {
                    ...
                    try {
                        String link = response.getString("Series_topRated_Link");
                        sharedPref.setTopRatedSerLink(link);
...
//            Toast.makeText(context, "null", Toast.LENGTH_SHORT).show();
            requestQueue = Volley.newRequestQueue(getActivity());
            String link = sharedPref.getTopRatedSerLink();
...
//                    Toast.makeText(getContext(), "Reached Top", Toast.LENGTH_SHORT).show();
        ...
        swipeRefreshLayoutSerTopRated.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            @Override
            public void onRefresh() {
                swipeRefreshLayoutSerTopRated.setRefreshing(false);
                userList.clear();
...
//                    deleteCache(getContext());
        ...
        swipeRefreshLayoutSerTopRated.setColorSchemeColors(Color.BLACK);
...
//            loadingPB.setVisibility(View.GONE);
        ...
        String url1 = sharedPref.getTopRatedSerLink() + location + "&page=" + page;
        RequestQueue requestQueue;
        if (getActivity() != null) {
